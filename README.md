...
requirements.txt             Python deps for the MNE function
...
3. Vercel will pick up `requirements.txt` automatically and install it for
   `api/analyze-artifacts.py`. First deploy may take a bit longer than
